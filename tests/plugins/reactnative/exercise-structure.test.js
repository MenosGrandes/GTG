...
const testsDir = path.join(root, "exercises", "tests", "reactnative");
const texDir = path.join(root, "exercises", "tex", "reactnative", "en");
...
describe("ReactNative exercise structure", () => {
