...
% Manual protection macro (for backward compatibility)
\def\rcm#1{%
  \directlua{
    local text = [[#1]]
    local garbled = make_garbled(text)
    tex.sprint("\\string\\pdfliteral{/Span <</ActualText (" .. garbled .. ")>> BDC}" .. text .. "\\string\\pdfliteral{EMC}")
  }%
}
