...
class ConfigLoader {
  ...
  getUtilsPath() {
    return join(this.getConfigJsDir(), this.#config.files.utils);
  }
  getObfuscatorConfigPath() {
    return join(this.getConfigJsDir(), this.#config.files.obfuscatorConfig);
  }
  ...
  getStudentFunctionsPath() {
    return join(this.getConfigJsDir(), this.#config.files.studentFunctions);
  }
