...
You will have \textbf{\testDuration} minutes to write code that should pass all provided tests. \\
...
\end{enumerate}
\includegraphics[width=\textwidth]{config/core/tex/img/npm_run_test}
