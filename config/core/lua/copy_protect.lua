...
local random_words = {"lorem", "ipsum", "dolor", "amet", "consectetur", "adipiscing", "elit", "sed", "eiusmod",
                      "tempor", "incididunt", "labore", "magna", "aliqua", "quis", "nostrud", "exercitation", "ullamco",
...
local function get_protection_probability()
    ...
    local status, prob_str = pcall(function()
        return token.get_macro("protectionProbability")
    end)
